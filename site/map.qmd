...
The map below shows these choke points alongside geolocalized conflict events from the UCDP dataset. Toggle between periods of high and low world trade to see how conflict patterns shift.
...
:::{.callout-tip}
## What to look for
In periods of **low trade openness**, conflict events cluster more densely near choke points. When trade is **booming**, this clustering weakens — major powers have stronger incentives to keep routes secure.
:::
